...
export class FH750 implements Updatable {
  #model: Group;
  ...
  constructor(scene: Group) {
    this.#model = scene;
    this.#wfl = getByName(scene, "FH-750-WFL");
    this.#wfr = getByName(scene, "FH-750-WFR");
    ...
    this.#wb = getByName(scene, "FH-750-WB");
  }
  ...
  rotateWheels(deltaTime: number) {
    ...
    this.#wb.rotation.x += wheelRotation;
  }
}
